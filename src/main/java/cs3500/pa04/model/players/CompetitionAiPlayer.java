...
import cs3500.pa04.model.jsonhandlers.JsonPlayerHandler;
...
public class CompetitionAiPlayer implements Player {
  ...
  /**
   * handles the "take-shots" request by checking the request Json, calculating the volley, and
   * generating a response with the volley coordinates.
   *
   * @param request The request message JSON.
   * @return The response message JSON containing the "take-shots" method and volley coordinates.
   */
  ...
  /**
   * Handles the "report-damage" request by checking the request JSON, extracting the opponent
   * shots coordinates, reporting the damage, and generating a response with the hit coordinates.
   *
   * @param request The request message JSON.
  ...
  /**
   * Handles the "successful-hits" request by checking the request JSON, extracting the
   * successful hits coordinates, handling the hits, and generating an empty response.
   *
   * @param request The request message JSON.
  ...
  /**
   * Handles the "end-game" request by checking the request JSON, extracting the game result
   * and reason, ending the game, and generating an empty response.
   *
   * @param request The request message JSON.
